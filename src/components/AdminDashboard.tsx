...
const translations = {
  ...
  hi: {
    ...
    featureInDevelopment: 'यह सुविधा वर्तमान में विकसित की जा रही है',
  ...
  pa: {
    ...
    featureInDevelopment: 'ਇਹ ਫੀਚਰ ਵਰਤਮਾਨ ਵਿੱਚ ਵਿਕਸਿਤ ਕੀਤਾ ਜਾ ਰਿਹਾ ਹੈ',
    reportDownloaded: 'ਰਿਪੋਰਟ ਸਫਲਤਾਪੂਰਵਕ ਡਾਉਨਲੋਡ ਹੋਈ',
