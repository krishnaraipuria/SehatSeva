...
export function VideoConsultation({ navigateTo, language, isOnline }: VideoConsultationProps) {
          ...
          {isConnected ? (
            ...
            <div className="text-center text-white space-y-4">
              ...
              <div>
                ...
                <p className="text-xl font-medium">{t.drSharma}</p>
                <p className="text-sm text-gray-300">{t.generalPhysician}</p>
              </div>
